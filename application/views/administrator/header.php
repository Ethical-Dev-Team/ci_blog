<body class="horizontal-static">
    ...
    <nav class="navbar header-navbar sticky-top">
        
        <div class="navbar-wrapper row"  style="width: 100%;">
            ...
            <div class="navbar-container container-fluid col-md-6">
                <div>
                    <ul class="nav-left">
                        <li>
                    ...
                    <ul class="nav-right">
                        ...
                        <li class="user-profile header-notification">
                            <a href="#!">
                                ...
                                <span>Your Profile &nbsp;<?php echo $this->session->userdata('username'); ?></span>
