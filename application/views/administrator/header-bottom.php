...
<!-- Menu aside start -->
<div class="main-menu vh-100">

<!-- This is icon updaer the admin dashboard -->
    ...
    <div class="main-menu-content">
        <ul class="main-navigation">
            ...
            <li class="nav-item">
                ...
                <ul class="tree-1">
                    <li class="nav-sub-item"><a href="#">Questions and Answers Category</a>
                        <ul class="tree-2">
                            <li><a href="<?php echo base_url(); ?>administrator/faq-categories/create">Add Questions and Answers Category</a></li>
                            <li><a href="<?php echo base_url(); ?>administrator/faq-categories">List Questions and Answers Category </a></li>
                        </ul>
                    </li>
                    <li class="nav-sub-item"><a href="#">Questions and Answers Posts</a>
                        <ul class="tree-2">
                            <li><a href="<?php echo base_url(); ?>administrator/faq/create">Add Questions and Answers Posts</a></li>
                            <li><a href="<?php echo base_url(); ?>administrator/faq">List Question and Asnsers</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
